...
The development process does not require Docker, WSL, Linux, or Docker Compose. Production requires `DATABASE_URL` and the deployed Base Sepolia configuration; production never uses the in-memory repository.
